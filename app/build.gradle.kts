...
android {
    namespace = "com.schwabtrader.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.schwabtrader.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField(
            "String",
            "SCHWAB_CLIENT_ID",
            "\"${localProperties.getProperty("SCHWAB_CLIENT_ID", "")}\""
        )
        buildConfigField(
            "String",
        ...
        manifestPlaceholders["appAuthRedirectScheme"] = "com.schwabtrader.app"
    }
